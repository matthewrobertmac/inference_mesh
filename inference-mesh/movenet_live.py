...
def run_webcam_inference():
    ...
    while True:
        ...
        # Resize and reshape image to expected input
        ...
        # Print out keypoints_with_scores for debugging
        print(keypoints_with_scores)

        # Draw prediction on image
        image_with_prediction = draw_prediction_on_image(frame, keypoints_with_scores)

        cv2.imshow('frame', image_with_prediction)
