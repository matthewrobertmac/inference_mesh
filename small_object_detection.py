...
class ImageProcessor:
    ...
    def process(self):
        ...
        for idx in idxs:
            ...
            print(f"Label: {self.objects[idx].label}, Probability: {self.objects[idx].score}")
            object_labels = f"Label: {self.objects[idx].label}, Probability: {self.objects[idx].score}"
